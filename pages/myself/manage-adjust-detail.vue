  ...
  <view class="view-content" v-if="data.allocation_info.id">
    ...
    <view class="content">
      ...
      <view class="content-box content-box-2">
        ...
        <view class="line-list" v-if="data.allocation_info.mode_code == 2">
          <view class="line">
            <view class="l">
        ...
        <view class="line-list" v-else>
          <view class="line">
            <view class="l">
              <view class="big">发起划分</view>
              <view class="sm">{{data.allocation_info.apply_personnel_name}}</view>
            </view>
            <div class="r">{{data.allocation_info.create_time}}</div>
          </view>
...
<script>
  ...
  import {allocationInfoApi} from '@/service/user.services.js'
  export default {
    data() {
      return {
        curStatus: '',
    ...
    onLoad(option) {
      ...
      **/
      ...
      this.id = option.id
      console.log(this.modeCode, 'uuuuu')
    },
    onShow() {
      uni.showLoading({
          title: '加载中'
    ...
    methods:{
      ...
      draw(type) {
        ...
        uni.navigateTo({
          url: "/pages/myself/manage-agaree?type=4"
        })
      }
    }
  }
